      ...
      <header className="mb-6 shrink-0">
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 mb-6">
          ...
          <div className="flex flex-col sm:flex-row gap-4 items-end">
            <Link href="/admin/inventory" className="bg-white/80 backdrop-blur-xl px-5 py-4 rounded-2xl shadow-sm border border-white flex items-center justify-center gap-2 hover:bg-white transition-colors group">
              <span className="text-2xl group-hover:scale-110 transition-transform">📦</span>
              <span className="font-bold text-gray-700">재고 관리</span>
            </Link>
